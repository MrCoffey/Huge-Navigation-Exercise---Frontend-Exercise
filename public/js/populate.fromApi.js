...
// Take an element by id and a Json object, looks for a node with that id and create new <li>
// Then seeds those lists with anchors created using the nested items.
function renderHTML(element, items){

  items.forEach(function(e){
    writteNode(element, '<li id="'+ e.label +'" class="toggle"><a href="' + e.url + '">' + e.label + '</a><span class="chevron"></span></li>');
